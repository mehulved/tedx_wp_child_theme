                        ...
                        <ul class="sidebar-list">
                            ...
                            <li id="sm_sidebar">
                                ...
                                <div class="textwidget">
                                    <a href="<?php echo get_bloginfo('rss2_url');?>" rel="alternate" type="application/rss+xml" target="_blank">
                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/rss.png" alt="Subscribe to RSS Feed" />
                                    </a>
                                    <a href="<?php echo get_option('tedx_twitter_url'); ?>" rel="nofollow" target="_blank">
                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/twitter.png" alt="Follow on Twitter" />
                                    </a>
                                    <a href="<?php echo get_option('tedx_fb_url'); ?>" rel="nofollow" target="_blank">
                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/facebook.png" alt="Like on Facebook" />
                                    </a>
                                    <a href="<?php echo get_option('tedx_yt_url'); ?>" rel="nofollow" target="_blank">
